      ...
      REAL(KIND=DPSIZE), POINTER ::CL,VC,VP,Q2,KA,S1,S2,S3,V2,V3,Q,Y
      ...
      KA=>COM(00005);S1=>COM(00006);S2=>COM(00007);S3=>COM(00008)
      V2=>COM(00009);V3=>COM(00010);Q=>COM(00011);Y=>COM(00012)
...
!                      A00043 = DERIVATIVE OF S2 W.R.T. ETA(002)
      A00043=A00036 
!                      A00045 = DERIVATIVE OF V2 W.R.T. ETA(002)
      A00045=A00036 
      GG(001,1,1)=CL
      GG(001,002,1)=A00032
      GG(002,1,1)=V2
...
!                      A00046 = DERIVATIVE OF A00045 W.R.T. ETA(002)
      ...
      GG(002,003,003)=A00046
      GG(005,004,004)=A00042
      GG(007,003,003)=A00044
      ENDIF
      RETURN
      END
