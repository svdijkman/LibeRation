      ...
      REAL(KIND=DPSIZE), POINTER ::CL,VC,VP,Q2,VP2,Q3,KA,V2,V3,V4,Q,Q4
      REAL(KIND=DPSIZE), POINTER ::S1,S2,S3,S4,Y,A00032,A00034,A00036
      REAL(KIND=DPSIZE), POINTER ::A00037,A00038,D00001,D00002,D00003
      REAL(KIND=DPSIZE), POINTER ::D00004,D00005,D00006,D00007,D00008
      REAL(KIND=DPSIZE), POINTER ::D00009,D00042,D00041,D00040,C00032
      REAL(KIND=DPSIZE), POINTER ::D00045,D00044,D00043,C00033
      CONTAINS
      SUBROUTINE ASSOCNMPRD4
      COM=>VRBL
      CL=>COM(00001);VC=>COM(00002);VP=>COM(00003);Q2=>COM(00004)
      VP2=>COM(00005);Q3=>COM(00006);KA=>COM(00007);V2=>COM(00008)
      V3=>COM(00009);V4=>COM(00010);Q=>COM(00011);Q4=>COM(00012)
      S1=>COM(00013);S2=>COM(00014);S3=>COM(00015);S4=>COM(00016)
      Y=>COM(00017);A00032=>COM(00018);A00034=>COM(00019)
      A00036=>COM(00020);A00037=>COM(00021);A00038=>COM(00022)
      D00001=>COM(00023);D00002=>COM(00024);D00003=>COM(00025)
      D00004=>COM(00026);D00005=>COM(00027);D00006=>COM(00028)
      D00007=>COM(00029);D00008=>COM(00030);D00009=>COM(00031)
      D00042=>COM(00032);D00041=>COM(00033);D00040=>COM(00034)
      C00032=>COM(00035);D00045=>COM(00036);D00044=>COM(00037)
      D00043=>COM(00038);C00033=>COM(00039)
...
!                      A00036 = DERIVATIVE OF KA W.R.T. ETA(003)
      A00036=THETA(007)*B00003 
!                      A00037 = DERIVATIVE OF V2 W.R.T. ETA(002)
      A00037=A00034 
!                      A00038 = DERIVATIVE OF S2 W.R.T. ETA(002)
      A00038=A00037 
      GG(001,1,1)=CL
      GG(001,002,1)=A00032
      GG(002,1,1)=V2
...
!                      D00043 = DERIVATIVE OF C00032 W.R.T. ETA(003)
      D00043=D00003 
!                      D00044 = DERIVATIVE OF C00032 W.R.T. ETA(002)
      D00044=D00002 
!                      D00045 = DERIVATIVE OF C00032 W.R.T. ETA(001)
      D00045=D00001 
      G(001,1)=D00042
      G(002,1)=D00041
      G(003,1)=D00040
      ...
      NAME_FSIZES(44)='NTT'; F_SIZES(44)=7
