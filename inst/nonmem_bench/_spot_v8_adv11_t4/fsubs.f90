      ...
      REAL(KIND=DPSIZE), POINTER ::CL,VC,VP,Q2,VP2,Q3,S1,S2,S3,V1,V2
      REAL(KIND=DPSIZE), POINTER ::V3,Q,Y,A00032,A00034,A00035,A00036
      CONTAINS
      SUBROUTINE ASSOCNMPRD4
      COM=>VRBL
      CL=>COM(00001);VC=>COM(00002);VP=>COM(00003);Q2=>COM(00004)
      VP2=>COM(00005);Q3=>COM(00006);S1=>COM(00007);S2=>COM(00008)
      S3=>COM(00009);V1=>COM(00010);V2=>COM(00011);V3=>COM(00012)
      Q=>COM(00013);Y=>COM(00014);A00032=>COM(00015)
...
!                      A00035 = DERIVATIVE OF S1 W.R.T. ETA(002)
      A00035=A00034 
!                      A00036 = DERIVATIVE OF V1 W.R.T. ETA(002)
      A00036=A00034 
      GG(001,1,1)=CL
      GG(001,002,1)=A00032
      GG(002,1,1)=V1
