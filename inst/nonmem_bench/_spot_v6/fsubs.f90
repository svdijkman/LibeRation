      ...
      REAL(KIND=DPSIZE), POINTER ::CL,VC,VP,Q2,V1,V2,Q,S1,S2,Y,A00032
      ...
      V1=>COM(00005);V2=>COM(00006);Q=>COM(00007);S1=>COM(00008)
      S2=>COM(00009);Y=>COM(00010);A00032=>COM(00011)
...
!                      A00039 = DERIVATIVE OF V1 W.R.T. ETA(002)
      A00039=A00036 
!                      A00041 = DERIVATIVE OF S1 W.R.T. ETA(002)
      A00041=A00039 
      GG(001,1,1)=CL
      GG(001,002,1)=A00032
      GG(002,1,1)=V1
