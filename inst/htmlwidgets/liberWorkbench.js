(function () {
  ...
  function ProjectTree(props) {
    ...
    var covarianceStep = React.useState(false), covarianceType = React.useState("sandwich"), covarianceTolerance = React.useState(0.00000001), covarianceSamples = React.useState(200);
